...
imagen = mpimagen.imread('imagenes/0/0_005.png')#Se importa la imagen a la variable.
...
def Distancia_Euclidiana(razon,pixeles_blancos,cont1,cont2,cont3,cont4,cont5,cont6,cont7,cont8,cont9,cont10,cont11,cont12):
    ...
    for i in dataset:#Ciclo for que recorre el dataset.
        ...
        dataset[contador][2]=int(dataset[contador][2])#Se convierte el valor contenido en la posición contador, 2.
        dataset[contador][3]=int(dataset[contador][3])#Se convierte el valor contenido en la posición contador, 3.
        dataset[contador][4]=int(dataset[contador][4])#Se convierte el valor contenido en la posición contador, 4.
        dataset[contador][5]=int(dataset[contador][5])#Se convierte el valor contenido en la posición contador, 5.
        dataset[contador][6]=int(dataset[contador][6])#Se convierte el valor contenido en la posición contador, 6.
        dataset[contador][7]=int(dataset[contador][7])#Se convierte el valor contenido en la posición contador, 7.
...
def Comparación():
    ...
    for x in range(0,k):#Ciclo for que recorre desde cero hasta k (los vecinos indicados)
        ...
        print('Instancia: ',dataset[x][16],"  Distancia: ",(dataset[x][15]),"  Clase: ",[dataset[x][14]])
    print('\n')
...
def main():
    dimenciones=Calcular_dimenciones(imagen)#A la variable dimenciones se le asigna el valos obtenido en la función Calcular_dimenciones indicando los parámetros.
    razon=Razon(dimenciones)#A la variable razon se le asigna el valos obtenido en la función Razon indicando los parámetros.
    pixeles_blancos=Pixeles_blancos(imagen,dimenciones)#A la variable pixeles_blancos se le asigna el valos obtenido en la función Pixeles_blancos indicando los parámetros.
    cont1,cont2,cont3,cont4,cont5,cont6=Numero_De_Bits_Que_Representan_La_Imagen(imagen,dimenciones)#A las variables cont1,cont2,cont3,cont4,cont5,cont6 se le asigna el valos obtenido en la función Numero_De_Bits_Que_Representan_La_Imagen indicando los parámetros.
    cont7,cont8,cont9,cont10,cont11,cont12=Cambios_en_la_imagen(imagen,dimenciones)#A las variables cont7,cont8,cont9,cont10,cont11,cont12 se le asigna el valos obtenido en la función Cambios_en_la_imagen indicando los parámetros.
